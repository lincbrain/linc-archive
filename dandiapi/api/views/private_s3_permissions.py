...
#         .replace("/", "~")
#
# def transform_presigned_url_to_cookies(presigned_url):
#     # Parse the URL
#     parsed_url = urlparse(presigned_url)
#     query_params = parse_qs(parsed_url.query)
#
#     # Transform the signature to its original base64 format
#     # Replace URL-safe base64 characters to standard base64 characters
#     signature = query_params['Signature'][0]
#     good_signature = _replace_unsupported_chars(signature)
#
#     # Extract the relevant parts for the cookies
#     cookies = {
#         'CloudFront-Expires': query_params['Expires'][0],
#         'CloudFront-Signature': good_signature,
#         'CloudFront-Key-Pair-Id': query_params['Key-Pair-Id'][0]
#     }
#
#     return cookies
...
def presigned_cookie_s3_cloudfront_view(request: Request) -> HttpResponseBase:
    ...
    # cookies = transform_presigned_url_to_cookies(get_presigned_url())
